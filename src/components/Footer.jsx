  ...
  return (
    <div className= " md:hidden  w-full fixed bottom-0  bg-black rounded-xl ">
      ...
      <ul className="   flex  p-1 items-center  justify-evenly font-semibold  rounded-bl-3xl rounded-tr-3xl " >
                ...
                <li className="cursor-pointer flex items-center justify-center p-2 h-10 rounded-lg text-white   hover:bg-white   border-2 hover:text-blue-600 duration-300  hover:scale-y-110  hover:-scale-x-125"> <Link to={'/contact'}> <MdPermContactCalendar /> </Link> </li>
